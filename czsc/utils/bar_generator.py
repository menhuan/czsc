...
def freq_end_time(dt: datetime, freq: Freq) -> datetime:
    ...
    if freq in [Freq.F1, Freq.F5, Freq.F15, Freq.F30, Freq.F60]:
        ...
        if m < 60:
            ...
            dt_span = {
                60: ["01:00","01:00", "2:00","03:00", "4:00", "5:00", "06:00", "7:00", "8:00", "9:00", "10:00", "11:00", "12:00", "13:00", "14:00",  "15:00",  '16:00', "17:00", "18:00", "19:00",  "20:00", "21:00","22:00", "23:00", "23:59"],
            }
            for v in dt_span[m]:
                hour, minute = v.split(":")
    ...
    if freq in [Freq.F4H]:
        dt_span = {
                60: ["00:00", "4:00", "8:00", '12:00', "16:00", "20:00"],
            }
...
class BarGenerator:
    ...
    def __validate_freq_params(self):
        ...
        self.base_freq_constraint = {
            "1分钟": ['5分钟', '15分钟', '30分钟', '60分钟','4小时' ,'日线', '周线', '月线', '季线', '年线'],
            "5分钟": ['15分钟', '30分钟', '60分钟','4小时', '日线', '周线', '月线', '季线', '年线'],
            "15分钟": ['30分钟', '60分钟','4小时', '日线', '周线', '月线', '季线', '年线'],
