...
from czsc.enum import BiFreq, Freq
...
class BiAnDataCache:
    ...
    """
    def bian_btc_daily(self,ts_code, start_date=None, end_date=None, raw_bar=True,interval=BiFreq.F5,limit=1000,frep=Freq.F5):
        ...
        if not self.refresh and os.path.exists(file_cache):
            ...
            request_params ={"symbol": ts_code,"interval":interval,"startTime":start_date,"endTime":end_date,"limit":limit}
